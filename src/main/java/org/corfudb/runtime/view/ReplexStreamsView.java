...
/**
 * Created by amytai on 5//16.
 */
@Slf4j
public class ReplexStreamsView {

    /** The org.corfudb.runtime which backs this view. */
    CorfuRuntime runtime;

    public ReplexStreamsView(CorfuRuntime runtime)
    {
     ...
     * @return          A view
     */
    public ReplexStreamView get(UUID stream) {
                                ...
                                Function<SequencerClient.TokenResponse, Boolean> deacquisitionCallback)
    {
        while (true) {
            SequencerClient.TokenResponse token =
                    runtime.getSequencerView().nextTokenWrapper(streamIDs, 1, true);
