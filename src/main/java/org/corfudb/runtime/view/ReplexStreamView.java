 ...
 */
@Slf4j
public class ReplexStreamView implements AutoCloseable {
    ...
    class StreamContext implements Comparable<StreamContext> {
        ...
        AtomicLong streamAddressToRead;
        ...
        public StreamContext(UUID contextID, long maxAddress) {
            ...
            this.streamAddressToRead = new AtomicLong(0);
        }
    ...
    public ReplexStreamView(CorfuRuntime runtime, UUID streamID)
    {
